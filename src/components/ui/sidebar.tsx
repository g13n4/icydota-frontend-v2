    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar w-full dark:bg-gray-700/90 bg-gray-400/90",
            className,
          )}
          {...props}
        >
...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden md:block grid-rows-2"
      data-state={state}
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden h-full",
        className,
      )}
      {...props}
    />
